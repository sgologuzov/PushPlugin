...
// Call this to send an upstream message
PushNotification.prototype.send = function(successCallback, errorCallback, msgId, ttl, data) {
    if (errorCallback == null) { errorCallback = function() {}}
    ...
    cordova.exec(successCallback, errorCallback, "PushPlugin", "send", [msgId, ttl, data]);
}
